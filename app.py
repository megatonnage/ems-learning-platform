...
def results():
    ...
    recent = db.session.query(Answer, Question).join(Question).filter(
        Answer.user_id == user.id
    ).order_by(Answer.timestamp.desc()).limit(20).all()
...
def init_sample_questions():
    ...
    sample_questions = [
        ...
        # === WAITING ROOM CRITERIA ===
        {
            ...
            'options': ['HR 120, RR 24, SBP 90', 'HR 90, RR 18, SBP 130', 'HR 140, RR 30, SBP 80', 'GCS 13, HR 110, SBP 100'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Code 3 (emergency)', 'Code 2 (urgent)', 'BLS non-emergency', 'Patient can self-transport'],
            'correct_answer': 2,
        ...
        # === INTOXICATION / ALTERED MENTAL STATUS ===
        {
            ...
            'options': ['Left on scene with police', 'Code 3 to nearest ED', 'BLS to appropriate facility', 'Only if they consent'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['Strong odor of alcohol', 'GCS <13', 'Combative behavior', 'Slurred speech'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Immediate transport', 'Oral glucose if awake', 'IV D10 if IV established', 'Glucagon IM'],
            'correct_answer': 2,
        ...
        # === TRAUMA SCORES & TFTC ===
        {
            ...
            'options': ['Too Far To Care', 'Trauma Field Transport Criteria', 'Transport For Trauma Care', 'Trauma Facility Transport Category'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['No trauma center needed', 'TFTC - Transport to trauma center', 'Go to nearest ED', 'Wait for ALS'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Fall from standing', 'Fall >20 feet', 'Motorcycle crash <20 mph', 'Minor assault'],
            'correct_answer': 1,
        ...
        # === HOSPITAL CATCHMENTS ===
        {
            ...
            'options': ['Nearest ED', 'PCI-capable facility', 'Trauma center', 'Any hospital with cardiac unit'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Nearest ED', 'Trauma center with neurosurgery', 'Psychiatric facility', 'Urgent care'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Scene time <10 min, transport to nearest', 'Work on scene 20+ min', 'Transport to cardiac center only', 'Wait for ROSC before moving'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Half of total calculated', 'Full amount', 'Quarter of total', 'None until at hospital'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Before CPR', 'After ROSC', 'During CPR if IV access available', 'Not indicated'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['Rapid bolus', 'Slow maintenance', 'Nothing by mouth', 'Hypertonic solution'],
            'correct_answer': 1,
        ...
        # === MORE MEDICATION QUESTIONS ===
        {
            ...
            'options': ['2.5 mg via nebulizer', '5 mg via nebulizer', '10 mg via nebulizer', '0.5 mg via nebulizer'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['3 mg rapid IV push', '6 mg rapid IV push', '12 mg rapid IV push', '0.5 mg/kg IV'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Tachycardia', 'Hypotension or respiratory depression', 'Hypertension', 'Anxiety'],
            'correct_answer': 1,
        ...
        # === MORE TRANSPORT/WAITING ROOM ===
        {
            ...
            'options': ['Chest pain with diaphoresis', 'Sore throat, afebrile, vitals stable', 'Respiratory distress', 'Altered mental status'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Code 3', 'BLS to appropriate facility', 'Left with police', 'Refused transport'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Police only', 'BLS transport', 'Emergency transport with mental health evaluation', 'Left with family'],
            'correct_answer': 2,
        ...
        # === MORE TRAUMA QUESTIONS ===
        {
            ...
            'options': ['Only motor response', 'Eye, verbal, and motor response', 'Level of pain', 'Blood pressure'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['No trauma criteria', 'TFTC - trauma center required', 'BLS transport OK', 'Wait for ALS'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Only if >20 mph', 'Only if rollover', 'Yes - automatic criteria', 'Only if unrestrained'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['>0.5 mm', '>1 mm in limb leads, >2 mm in precordial leads', '>3 mm anywhere', 'Any ST elevation'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Only if 12-lead shows MI', 'To all patients with suspected ACS', 'Only if hypertensive', 'Never by EMTs'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['HR >100', 'SBP <90 or used PDE5 inhibitor', 'Patient is anxious', 'Pain is severe'],
            'correct_answer': 1,
        ...
        # === RESPIRATORY QUESTIONS ===
        {
            ...
            'options': ['Normal breathing', 'Accessory muscle use, tripod positioning', 'Bradypnea', 'Sleepiness'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Mild wheezing', 'Asthma not responding to initial treatment', 'No wheezing', 'Normal SpO2'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Improved SpO2 with O2', 'Altered mental status, fatigue, bradypnea', 'Increased wheezing', 'Tachycardia only'],
            'correct_answer': 1,
        ...
        # === PEDIATRIC QUESTIONS ===
        {
            ...
            'options': ['60-100 for all ages', 'Faster than adults, varies by age', 'Slower than adults', 'Always >150'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Head hyperextension', 'Neutral position (towel under shoulders)', 'Chin to chest', 'Lateral position'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['0.01 mg/kg IM (max 0.3 mg)', '0.3 mg IM fixed dose', '0.5 mg IM', '1 mg IM'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Hypertension', 'Hypovolemic shock (large body surface area)', 'Bradycardia', 'Hyperthermia'],
            'correct_answer': 1,
        ...
        # === OBSTETRIC QUESTIONS ===
        {
            ...
            'options': ['Contractions 10 minutes apart', 'Crowning, urge to push, contractions <2 min apart', 'No contractions', 'Mild cramping'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Immediate transport', 'McRoberts maneuver (knees to chest)', 'Fundal pressure', 'Pulling harder on baby'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['High blood pressure only', 'Seizures in pregnancy/postpartum', 'Low blood pressure', 'Normal delivery'],
            'correct_answer': 1,
        ...
        # === ENVIRONMENTAL QUESTIONS ===
        {
            ...
            'options': ['Temperature only', 'Altered mental status in heat stroke', 'Sweating', 'Heart rate'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Immediate CPR regardless', 'Airway and breathing assessment', 'Spinal immobilization', 'Transport only'],
            'correct_answer': 1,
        ...
        # === BEHAVIORAL/PSYCH QUESTIONS ===
        {
            ...
            'options': ['Immediate sedation', 'Scene safety', 'Psychiatric diagnosis', 'Physical restraint'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Prone position', 'Minimum necessary, supine or lateral', 'Tied tightly', 'Ignored'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Police only', 'Emergency transport to ED for evaluation', 'Family to watch', 'Promise not to do it again'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1 bolus', '2 boluses (40 mL/kg total)', '3 boluses', 'Unlimited until BP normalizes'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Fever', 'Respiratory distress with rales/crackles', 'Normal vitals', 'Minor trauma'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Rapid bolus to correct shock quickly', 'Cautious - risk of cerebral edema', 'Not given until glucose normalized', 'Hypertonic saline'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Tachycardia only', 'Hepatomegaly, JVD, rales, decreased responsiveness', 'Fever', 'Increased urine output'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['No fluids', '20 mL/kg bolus over 20 minutes', 'Maintenance only', 'D5W bolus'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['No fluids', 'Aggressive fluid resuscitation', 'Limited fluids, permissive hypotension', 'Blood transfusion'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['150 mL/hr', '300 mL/hr for first 8 hours', '600 mL total', 'No fluids in field'],
            'correct_answer': 1,
        ...
        # === COMPREHENSIVE PEDIATRIC MEDICATIONS ===
        {
            ...
            'options': ['0.15 mg/kg (min 2.5 mg, max 5 mg)', '2.5 mg fixed dose', '5 mg fixed dose', '0.5 mg/kg'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['0.1 mg/kg IM/IN (max 5 mg)', '0.5 mg/kg IM', '5 mg fixed dose', '0.05 mg/kg IV only'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Patient is unconscious', 'Patient is alert with gag reflex', 'Patient is seizing', 'Patient is vomiting'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Fever', 'Respiratory depression or altered mental status', 'Crying', 'Normal vitals'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['0.5 mg/kg IV/IM (max 25 mg)', '25 mg fixed dose', '50 mg fixed dose', '1 mg/kg (max 100 mg)'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['0.5 mcg/kg IN (max 50 mcg)', '1 mcg/kg IN (max 100 mcg)', '25 mcg fixed dose', '50 mcg fixed dose'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Defibrillation first', 'Rapid IV push followed by saline flush', 'Slow IV drip', 'IM injection'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1 mg/kg IV/IO (max 100 mg)', '5 mg/kg IV/IO (max 300 mg)', '150 mg fixed dose', '300 mg fixed dose'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Fever', 'Known prolonged QT syndrome', 'Dehydration', 'All pediatric patients'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['0.5 g/kg (5 mL/kg) slow IV', '1 g/kg (10 mL/kg) rapid IV', '2 g/kg IV push', 'D25 preferred'],
            'correct_answer': 0,
        ...
        # === PEDIATRIC SPECIAL CIRCUMSTANCES ===
        {
            ...
            'options': ['Atropine', 'Epinephrine', 'Oxygenation and ventilation support', 'Defibrillation'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['30 breaths/minute', '20-30 breaths/minute', '12-20 breaths/minute', 'As fast as possible'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Hypertension', 'Normal or low BP with signs of poor perfusion (compensated shock)', 'Bradycardia', 'Increased urine output'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['One hand for seal, one for squeeze', 'Two hands for seal, one for squeeze', 'One person only', 'High pressure ventilation'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Simple viral illness', 'Febrile seizure, meningitis, or sepsis', 'Heat exhaustion', 'Hypoglycemia only'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['No medications needed', 'Analgesia (pain control) AND sedation', 'Sedation only', 'Paralytic only'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Confront the parents immediately', 'Document findings objectively and report suspicions', 'Ignore it as not your concern', 'Transport without documentation'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Good prognosis with aggressive resuscitation', 'Poor prognosis - consider terminating if no reversible cause', 'Always due to hypothermia', 'Better outcomes than adults'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['120 mL, total 360 mL', '240 mL, total 480 mL (40 mL/kg)', '500 mL, total 740 mL', '1000 mL total'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1000 mL - give rapidly', '1000 mL - give cautiously due to cerebral edema risk', '2000 mL - DKA needs more', 'No fluids until glucose normalized'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['180 mL, then 180 mL more', '200 mL, then 200 mL more', '150 mL, then reassess', 'No bolus - infants get IV only'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['1320 mL total, 660 mL in first 8 hours', '2640 mL total, 1320 mL in first 8 hours', '3000 mL total', '500 mL in first 8 hours'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Give full 560 mL bolus', 'Give half bolus (280 mL)', 'No bolus - suspected CHF/fluid overload', 'Give 1000 mL regardless'],
            'correct_answer': 2,
        ...
        # === PEDIATRIC CONTRAINDICATIONS & EXCEPTIONS ===
        {
            ...
            'options': ['No - contraindicated', 'Yes - albuterol is not a sulfa drug', 'Only if severe', 'Give epinephrine instead'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Rapid IV push with immediate flush', 'Slow IV drip', 'IM injection', 'Subcutaneously'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['0.3 mg/kg PO/IM (max 10 mg)', '0.6 mg/kg PO/IM (max 10 mg)', '1 mg/kg', '2 mg/kg'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1 mg in one nostril', '2 mg total (1 mg each nostril)', '4 mg in one nostril', '0.5 mg total'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['0.01 mg/kg IV/IO (1:10,000)', '0.1 mg/kg IV/IO', '0.01 mg/kg IM', '0.3 mg fixed'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['0.01 mg/kg (min 0.1 mg, max 0.5 mg)', '0.02 mg/kg IV', '0.1 mg fixed', '0.5 mg fixed'],
            'correct_answer': 0,
        ...
        # Sedation/Analgesia combos
        {
            ...
            'options': ['20 mcg fentanyl + 2 mg midazolam', '40 mcg fentanyl + 4 mg midazolam', '60 mcg fentanyl + 6 mg midazolam', '100 mcg fentanyl + 10 mg midazolam'],
            'correct_answer': 1,
        ...
        # Special scenarios
        {
            ...
            'options': ['0.01 mg/kg once', '0.02 mg/kg, double every 5 min until secretions dry', '0.1 mg/kg single dose', '1 mg fixed regardless of weight'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Premature <3 kg', 'Term newborn 3-5 kg', '3-6 months 5-7 kg', '6-12 months 8-10 kg'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['A systolic blood pressure of 70 mmHg in a 1-year-old', 'The patient remains tachycardic', 'Presence of rales on lung exam', 'The patient develops a fever'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['Administer an antiemetic', 'Perform retroperitoneal palpation', 'Check a blood glucose level', 'Repeat vital signs'],
            'correct_answer': 3,
        ...
        },
        {
            ...
            'options': ['No fluid bolus is indicated for bradycardia', '10 ml/kg bolus', 'D10 at 5 ml/kg', '20 ml/kg bolus'],
            'correct_answer': 3,
        ...
        },
        {
            ...
            'options': ['Neonatal Resuscitation', 'Pediatric Allergic Reaction', 'Pediatric Burns', 'Pediatric Abdominal Pain'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['NS or LR bolus at 125 ml', 'NS or LR bolus at 20 ml/kg', 'NS bolus at 500 ml', 'Hydroxocobalamin only'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Oral glucose regardless of BG level', 'Administer high-dose Epinephrine', 'Wait for medical direction', 'Administer the patient\'s own Solu-Cortef'],
            'correct_answer': 3,
        ...
        },
        {
            ...
            'options': ['For further drip rates or additional boluses', 'To confirm the patient\'s age', 'To report blood glucose levels', 'To request an initial fluid bolus'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['8 years of age or older', '12 years of age or older', '10 years of age or older', '2 years of age or older'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Min: 0.5 mg; Max: 3 mg', 'Min: 0.1 mg; Max: 0.5 mg', 'Min: 0.1 mg; Max: 1 mg', 'Min: 0.02 mg; Max: 1 mg'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['150 mg over 10 minutes', '5 mg/kg rapid IV push', '5 mg/kg in 50 ml NS over 20 minutes', '0.2 mg/kg over 20 minutes'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['1:1000, 0.1 mg/kg', '1:10,000, 0.01 mg/kg', '1:1000, 0.01 mg/kg', '1:10,000, 0.1 mg/kg'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['2 g fixed dose', '5 mg/kg over 20 minutes', '50 mg/kg rapid IV push', '25 mg/kg in 50 ml NS over 10 minutes'],
            'correct_answer': 3,
        ...
        },
        {
            ...
            'options': ['0.1 mg/kg Dexamethasone', 'The patient\'s own Solu-Cortef (hydrocortisone)', '2 mg/kg Methylprednisolone', '0.01 mg/kg Epinephrine'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1:10,000, 0.01 mg/kg', '1:1000, 0.01 mg/kg', '1:10,000, 0.1 mg/kg', '1:1000, 0.1 mg/kg'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['Do not exceed 10 ml/kg', 'No limit is specified for DKA', 'Do not exceed 20 ml/kg', 'Do not exceed 60 ml/kg'],
            'correct_answer': 0,
        ...
        },
        {
            ...
            'options': ['First menstrual cycle', 'Height over 5 feet', 'Age over 12 years', 'Any breast development'],
            'correct_answer': 3,
        ...
        },
        {
            ...
            'options': ['Round up to the nearest 1/2 pill', 'Round down to the nearest whole pill', 'Do not round, administer exact weight-based dose', 'Round to the nearest 1/4 pill'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Never use an auto-injector on a child', 'Never give Epinephrine to a child under 5 kg', 'Never give Epinephrine 1:1000 (IM concentration) through IV/IO route', 'Never repeat Epinephrine more than once'],
            'correct_answer': 2,
        ...
        },
        {
            ...
            'options': ['General Pediatric Assessment', 'Administer Oxymetazoline', 'Apply an ice pack to the bridge of the nose', 'Direct pressure for 15 minutes'],
            'correct_answer': 0,
...
def cleanup_db():
    ...
    try:
        with app.app_context():
            ...
            if delete_ids:
                Answer.query.filter(Answer.question_id.in_(delete_ids)).delete(synchronize_session=False)
                db.session.commit()
