...
from app import Question, app, db
    ...
    questions.extend(
        [
            ...
            },
            {
                ...
                "options": [
                    "Standard 1000 mL bolus",
                    "250 mL boluses with reassessment",
                    "No fluids unless SBP < 90",
            ...
            },
            {
                ...
                "options": [
                    "Give second 1000 mL bolus",
                    "Start vasopressors immediately",
                    "Give 500 mL bolus and reassess",
    ...
    questions.extend(
        [
            ...
            },
            {
                ...
                "options": [
                    "Aggressive 40 mL/kg bolus",
                    "No fluids - risk of cerebral edema",
                    "10-20 mL/kg bolus over 1-2 hours",
                    "Standard 20 mL/kg rapid bolus",
                ],
                "correct_answer": 2,
    ...
    questions.extend(
        [
            ...
            },
            {
                ...
                "options": [
                    "0.01 mg/kg IV/IM (max 2 mg)",
                    "0.1 mg/kg IV/IM (max 2 mg)",
                    "2 mg IN (fixed dose)",
                    "0.4 mg IM only",
                ],
                "correct_answer": 1,
            ...
            },
            {
                ...
                "options": [
                    "0.05 mg/kg rapid IV push (max 6 mg)",
                    "0.1 mg/kg rapid IV push (max first dose 6 mg)",
                    "0.2 mg/kg rapid IV push (max 12 mg)",
                    "1 mg rapid IV push (fixed dose)",
                ],
                "correct_answer": 1,
    ...
    questions.extend(
        [
            ...
            },
            {
                ...
                "options": [
                    "SBP < 120 mmHg",
                    "SBP < 90 mmHg or use of PDE5 inhibitors within 24-48 hours",
                    "HR > 100",
        ...
        [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "SBP > 110 mmHg",
                    "HR < 100 bpm",
                    "Severe, constant pain with guarding",
                ],
                "correct_answer": 3,
        ...
        [
            {
                ...
                "options": [
                    ...
                    "GCS < 15 or inability to protect airway",
                    "They can walk unassisted",
                    "They have a sober friend to drive them",
                ],
                "correct_answer": 1,
            ...
            },
            {
                ...
                "options": [
                    ...
                    "They are ambulatory, vitals stable, and can be observed by responsible adult",
                    "They sign a refusal form",
            ...
            },
            {
                ...
                "options": [
                    "Release immediately - problem solved",
                    "Transport required - risk of renarcotization",
                    "Release if they sign refusal",
                    "Only transport if they used fentanyl",
                ],
                "correct_answer": 1,
        ...
        [
            {
                ...
                "options": [
                    ...
                    "Pupil size, eye opening, limb movement",
                    "Alertness, pain response, verbalization",
                ],
                "correct_answer": 1,
            ...
            },
            {
                ...
                "options": [
                    "RTS = 10 (minor trauma)",
                    "RTS = 8 (moderate trauma)",
                    "RTS calculation requires additional data",
                    "RTS = 6 (severe trauma)",
                ],
                "correct_answer": 2,
            ...
            },
            {
                ...
                "options": [
                    "Minor injuries from MVC",
                    "Obvious death or unsurvivable injuries",
                    "Stable vital signs",
            ...
            },
            {
                ...
                "options": [
                    "The patient with the loudest complaints",
                    "The patient with immediate life threats who can be rapidly stabilized",
                    "The patient with minor injuries",
                    "The patient who is unresponsive with no pulse",
                ],
                "correct_answer": 1,
            ...
            },
            {
                ...
                "options": [
                    "HR increasing from 80 to 110",
                    "SBP dropping from 140 to 100",
                    "HR increasing and SBP dropping (pulse pressure narrowing)",
                    "RR increasing from 16 to 24",
                ],
                "correct_answer": 2,
            ...
            },
            {
                ...
                "options": [
                    "Single worst injury",
                    "Sum of all injury severities",
                    "Sum of squares of highest AIS scores in 3 most severely injured body regions",
                    "GCS + RTS + age",
                ],
                "correct_answer": 2,
        ...
        [
            {
                ...
                "options": [
                    ...
                    "A PCI-capable hospital (STEMI receiving center)",
                    "Any hospital with an ER",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Any hospital with CT capability",
                    "Patient's insurance-approved facility",
                ],
                "correct_answer": 1,
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Trauma Center (Level I, II, or III based on severity)",
                    "Any hospital with surgery capability",
                    "Patient choice",
                ],
                "correct_answer": 1,
        ...
        [
            {
                ...
                "options": [
                    "Nearest hospital",
                    "Hospital with obstetric and trauma capabilities",
                    "Any Trauma Center",
            ...
            },
            {
                ...
                "options": [
                    "Be released at scene",
                    "Be transported for CT scan due to high-risk anticoagulation",
                    "Sign refusal after being informed of risks",
                    "Only transport if LOC or vomiting",
                ],
                "correct_answer": 1,
...
def add_questions_to_db():
    ...
    with app.app_context():
        ...
        categories = (
            db.session.query(Question.category, db.func.count(Question.id))
