...
def generate_questions_from_protocols():
    ...
    additional_questions = [
        # PEDIATRIC FLUIDS - More specific scenarios
        {
            ...
            'options': ['No fluids - PO only', '280 mL bolus (20 mL/kg)', '500 mL bolus', '1000 mL bolus'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Give 3rd bolus immediately', 'Reassess and consider dopamine/epinephrine infusion', 'Transport without further fluids', 'Give blood products'],
            'correct_answer': 1,
        ...
        # PEDIATRIC MEDS - Advanced scenarios
        {
            ...
            'options': ['More benzodiazepines', 'Levetiracetam (Keppra) or phenobarbital', 'Haloperidol', 'Diphenhydramine'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['1 mg/kg - causes hypotension', '2 mg/kg - maintains BP, good for shock', '0.5 mg/kg - short acting', '5 mg/kg - deep sedation'],
            'correct_answer': 1,
        ...
        # SNHD SPECIFIC - Waiting room & transport
        {
            ...
            'options': ['They request a specific hospital', 'They need specialized care not at nearest facility', 'They have minor complaints', 'They refuse transport'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Nearest adult trauma center', 'Pediatric-capable trauma center if available within reasonable distance', 'Any hospital with pediatric unit', 'Urgent care'],
            'correct_answer': 1,
        ...
        # INTOXICATION/AMS - SNHD specific
        {
            ...
            'options': ['Any intoxicated patient', 'GCS 14-15, stable vitals, no trauma, medically cleared', 'GCS <13', 'Combative and violent'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Transport to nearest ED', 'Meets TFTC - transport to trauma center', 'Only if they have injuries', 'BLS transport OK'],
            'correct_answer': 1,
        ...
        # HOSPITAL CATCHMENTS
        {
            ...
            'options': ['Nearest ED', 'Primary Stroke Center or Comprehensive Stroke Center', 'Urgent care', 'Rehab facility'],
            'correct_answer': 1,
        ...
        },
        {
            ...
            'options': ['Non-PCI hospital (closer)', 'PCI-capable facility despite longer transport', 'Either is fine', 'Urgent care'],
            'correct_answer': 1,
